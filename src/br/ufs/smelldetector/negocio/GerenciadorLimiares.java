...
public class GerenciadorLimiares {
	...
	public static HashMap<LimiarMetricaKey, LimiarMetrica> obterLimiarBenchMarkPercentil(
			ArrayList<String> projetosBenchmark, int percentil) {
	...
	public static HashMap<LimiarMetricaKey, LimiarMetrica> obterLimiarBenchMarkDesignRole(
			ArrayList<String> projetosBenchMark, int percentil) {
...
//	 * @return
//	 */
//	public static List<DadosClasse> obterListaClassesProjetoExemplo(boolean adicionarArquitetura, String projetoExemplo) {
